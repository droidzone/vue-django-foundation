...
export default createStore({
  ...
  mutations: {
    ...
    SET_USER_DATA(state, data_obj) {
      console.log(
        `In mutation:SET_USER_DATA user_id:${data_obj.user_id} email:${data_obj.email} token:${data_obj.token}`
      );
      ...
      axios.defaults.headers.common["Authorization"] = `Token ${data_obj.token}`;
      // Authorization: Token; 
      console.log(
        `Stored token as ${axios.defaults.headers.common["Authorization"]}`
      );
    },
  },
  actions: {
